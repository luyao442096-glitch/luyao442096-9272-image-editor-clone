...
export const translations = {
  en: {
    ...
    pricingTitle: "Choose Your Credit Pack",
    pricingSubtitle: "Flexible credit packs to suit your needs. Purchase credits when you need them.",
    monthly: "Monthly",
    yearly: "Yearly",
    save50: "Save 50%",
    ...
    highQualityImagesPerMonth: "high-quality images",
    subscribeNow: "Subscribe Now",
    buyCredits: "Buy Credits",
    creditSystemTitle: "Credit System",
    creditSystemDescription: "2 credits generate 1 high-quality image. Credits are used when you generate images.",
    creditPackInfo: "Credit Pack Information",
    creditPackInfoDesc: "Each credit pack gives you credits to use for image generation.",
    creditUsageInfo: "Credit Usage",
    creditUsageInfoDesc: "Credits never expire. Use them whenever you need.",
  ...
  zh: {
    ...
    // Pricing
    pricingBadge: "定价",
    pricingTitle: "选择您的积分包",
    pricingSubtitle: "灵活的积分包满足您的需求。需要时购买积分。",
    monthly: "月付",
    yearly: "年付",
    save50: "节省50%",
    mostPopular: "最受欢迎",
    ...
    year: "年",
    creditsPerYear: "积分",
    highQualityImagesPerMonth: "张高质量图片",
    subscribeNow: "立即订阅",
    buyCredits: "购买积分",
    creditSystemTitle: "积分系统",
    creditSystemDescription: "2积分生成1张高质量图片。生成图片时会消耗积分。",
    creditPackInfo: "积分包信息",
    creditPackInfoDesc: "每个积分包为您提供用于图像生成的积分。",
    creditUsageInfo: "积分使用",
    creditUsageInfoDesc: "积分永不过期。随时使用。",
    paymentMethods: "安全支付方式",
    creditCard: "信用卡",
    debitCard: "借记卡",
